...
public class Parameters : GenericParameters
{
    ...
    public Parameters(int dicesCount = 1, int additionalDicesCount = 0,
                      int rerollsCount = 0, int burstsCount = 0, int bonus = 0) :
        base(DefaultDiceFacesCount, dicesCount, additionalDicesCount, rerollsCount, burstsCount, bonus)
    {
    }
}
